        ...
        <?php
            ...
            foreach ( $mespartiesproposees as $partie ):
                ...
                <tr>
                    ...
                    <td class="infobulle" data-info="<?php echo $contenuadversaire; ?><img src='<?php echo $adversaire->photo() ?>'"><?php echo $adversaire->pseudo() ?></td>
                    ...
                    <td><a href="?action=traiter partie&amp;but=refuser&id=<?php echo $partie->gidp() ?>"><img src="public/images/icons/effacer.png"  width="20" height="15" alt="refuser cette proposition" border="0" /></a></td>
                </tr>
            <?php
            endforeach;
            ?>
