...
DROP TABLE IF EXISTS `liste_coups`;
DROP TABLE IF EXISTS `type`;
DROP TABLE IF EXISTS `variantes`;
DROP TABLE IF EXISTS `variante_coups`;
...
INSERT INTO `liste` (`id`, `nom`, `id_type`) VALUES
...
(41, 'Gambit de la dame accepté', 3),
...
INSERT INTO `liste_coups` (`id`, `id_liste`, `id_coup`) VALUES
(3, 2, 3),
(4, 2, 4),
(6, 3, 6),
(7, 3, 7),
...
INSERT INTO `liste_variantes` (`id`, `id_ouverture`, `id_variante`) VALUES
(1, 5, 2),
(2, 5, 1),
(3, 5, 3),
(4, 5, 4),
...
INSERT INTO `variante_coups` (`id`, `id_variante`, `id_coup`) VALUES
(1, 1, 3),
(4, 2, 6),
(5, 2, 13),
(6, 2, 14),
