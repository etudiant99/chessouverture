...
class Reine extends Piece
{
    ...
    public function setImage()
    {
        if ($this->couleur($this->_nom) == 1)
            $this->_image = '<img border="0" src="./public/images/wq.gif" align="middle">';
        else
            $this->_image = '<img border="0" src="./public/images/bq.gif" align="middle">';
    }
    
    public function SetImageMangee()
    {
        if ($this->couleur($this->_nom) == 1)
            $this->_imagemangee = '<img border="0" src="./public/images/wq_21.gif" align="middle">';
        else
            $this->_imagemangee = '<img border="0" src="./public/images/bq_21.gif" align="middle">';      
    }
