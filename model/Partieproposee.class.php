...
class Partieproposee
{
    ...
    public function setImagemacouleur()
    {
        ...
        if ($this->macouleur() == '-')
        {
            $this->_imagemacouleur = '<img src="./public/images/icons/dice.png" alt="" border=0>';
            $this->_imagetacouleur = '<img src="./public/images/icons/dice.png" alt="" border=0>';
        }
           
        if ($this->macouleur() == 'b')
        {
            $this->_imagemacouleur = '<img src="./public/images/icons/white.gif" alt="" border=0>';
            $this->_imagetacouleur = '<img src="./public/images/icons/black.gif" alt="" border=0>';
        }
            
        if ($this->macouleur() == 'n')
        {
            $this->_imagemacouleur = '<img src="./public/images/icons/black.gif" alt="" border=0>';
            $this->_imagetacouleur = '<img src="./public/images/icons/white.gif" alt="" border=0>';
        }
    ...
    {
        $image = '<img src="./public/images/icons/accept.png">';
        return $image;
    }

    public function refuser()
    {
        $image = '<img src="./public/images/icons/delete.png">';
        return $image;
    }
