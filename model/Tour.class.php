...
class Tour extends Piece
{
    ...
    public function setImage()
    {
        if ($this->couleur($this->_nom) == 1)
            $this->_image = '<img border="0" src="./public/images/wr.gif" align="middle">';
        else
            $this->_image = '<img border="0" src="./public/images/br.gif" align="middle">';
    }
    
    public function SetImageMangee()
    {
        if ($this->couleur($this->_nom) == 1)
            $this->_imagemangee = '<img border="0" src="./public/images/wr_21.gif" align="middle">';
        else
            $this->_imagemangee = '<img border="0" src="./public/images/br_21.gif" align="middle">';      
    }
