...
class Fou extends Piece
{
    ...
    public function setImage()
    {
        if ($this->couleur($this->_nom) == 1)
            $this->_image = '<img border="0" src="./public/images/wb.gif" align="middle">';
        else
            $this->_image = '<img border="0" src="./public/images/bb.gif" align="middle">';
    }
    
    public function SetImageMangee()
    {
        if ($this->couleur($this->_nom) == 1)
            $this->_imagemangee = '<img border="0" src="./public/images/wb_21.gif" align="middle">';
        else
            $this->_imagemangee = '<img border="0" src="./public/images/bb_21.gif" align="middle">';      
    }
