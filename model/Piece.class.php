...
class Piece extends Couleur
{
    ...
    protected function imagepiecemangee($id)
    {
        ...
        {
            case "P":
                $image = '<img src="./public/images/wp_21.gif">';
                break;
            case "R":
                $image = '<img src="./public/images/wr_21.gif">';
                break;
            case "N":
                $image = '<img src="./public/images/wn_21.gif">';
                break;
            case "B":
                $image = '<img src="./public/images/wb_21.gif">';
                break;
            case "Q":
                $image = '<img src="./public/images/wq_21.gif">';
                break;
            case "K":
                $image = '<img src="./public/images/wk_21.gif">';
                break;

            case "p":
                $image = '<img src="./public/images/bp_21.gif">';
                break;
                         
            case "r":
                $image = '<img src="./public/images/br_21.gif">';
                break;
            case "n":
                $image = '<img src="./public/images/bn_21.gif">';
                break;
            case "b":
                $image = '<img src="./public/images/bb_21.gif">';
                break;
            case "q":
                $image = '<img src="./public/images/bq_21.gif">';
                break;
            case "k":
                $image = '<img src="./public/images/bk_21.gif">';
                break;
        }
